...
<body>
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                <button class="mobile-toggle" id="mobileToggle" aria-label="Open menu"><i class="fas fa-bars"></em></button>
                <a class="brand" href="#">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Primary navigation">
                <ul>
                    <li><a href="#"><i class="fas fa-home"></em> Home</a></li>
                    <li class="has-dropdown" aria-haspopup="true">
                        <a href="#" id="catMenuBtn"><i class="fas fa-th-large"></em> Categories <i class="fas fa-chevron-down" style="font-size:12px;"></em></a>
                    </li>
                    <li><a href="#"><i class="fas fa-fire"></em> Trending</a></li>
                    <li><a href="#deals"><i class="fas fa-tag"></em> Deals</a></li>
                    <li><a href="#about"><i class="fas fa-info-circle"></em> About</a></li>
                </ul>
            </nav>
            ...
            <div style="display:flex;align-items:center;gap:14px;">
                <div class="search" role="search" aria-label="Product search">
                    ...
                    <button class="icon-btn" id="searchBtn" aria-label="Search"><i class="fas fa-search"></em></button>
                </div>

                <div class="header-actions" role="group" aria-label="Header actions">
                    <a class="icon-btn" title="Account" href="#"><i class="far fa-user"></em></a>
                    <a class="icon-btn" title="Wishlist" href="#"><i class="far fa-heart"></em></a>
                    <a class="cart" href="#" id="cartBtn" title="View cart" aria-label="Cart">
                        <i class="fas fa-shopping-cart"></em>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Mysura Reddy Collections-Version5</h1>
                ...
                <div>
                    <button class="btn btn-primary" id="shopNow">Shop Now <i class="fas fa-arrow-right"></em></button>
        ...
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                ...
                <div style="margin-top:14px;display:flex;gap:10px">
                    <a class="icon-btn" href="#" title="Facebook"><i class="fab fa-facebook"></em></a>
                    <a class="icon-btn" href="#" title="Twitter"><i class="fab fa-twitter"></em></a>
                    <a class="icon-btn" href="#" title="Instagram"><i class="fab fa-instagram"></em></a>
                </div>
            </div>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon"><i class="fas ${cat.icon}"></em></div>
                    <h4>${cat.name}</h4>
            ...
            list.forEach(p => {
                ...
                el.innerHTML = `
                    ...
                    <div class="product-footer">
                        <button class="add-btn" data-id="${p.id}"><i class="fas fa-cart-plus"></em> Add</button>
                        <button class="wish-btn" aria-label="Add to wishlist"><i class="far fa-heart"></em></button>
                    </div>
                `;
